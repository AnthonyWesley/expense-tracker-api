    ...
    register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user) {
                    const createUser = yield User_1.User.create({ name, email, password });
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const decryptedPassword = yield bcryptjs_1.default.compare(password, user.password);
    ...
    createRecord(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield User_1.User.findOne({ where: { id: decode.userId } });
                if (user) {
